...
export const dict: Record<Lang, Dictionary> = {
  en: {
    ...
    auth: {
      ...
      securityNote: "Session-protected ledger. Company data stays private.",
    },
    ...
    fixedCostsSubtitle: "Recurring overhead for rent and subscriptions. Net profit is calculated after these costs.",
    ...
    projectCostsSubtitle: "Direct costs paid by partners. Included in total expenses.",
    ...
    stats: {
      ...
      netProfitHint: "Completed projects profit − company expenses",
    ...
    capital: {
      ...
      poolNote:
        "Project costs (hosting, domain) are paid out of collected cash. Net entitlements live in the Ledger.",
    ...
    ledger: {
      ...
      subtitle: "Balance = Pending reimbursements + Realized profit shares + Company overhead balance",
      noPartners: "No partners yet.",
      pendingShort: "Pending reimb.",
      profitShare: "Profit share",
      companyNet: "Company overhead balance",
      drawings: "Drawings",
  ...
  ar: {
    ...
    auth: {
      ...
      unavailable: "تسجيل الدخول غير متاح. حاول لاحقا.",
      logout: "تسجيل الخروج",
      showPassword: "إظهار كلمة المرور",
      hidePassword: "إخفاء كلمة المرور",
      securityNote: "دفتر محمي بجلسة. بيانات الشركة تبقى سرية.",
    },
    ...
    stats: {
      ...
      netProfitHint: "أرباح المشاريع المكتملة − مصاريف الشركة",
    ...
    footer: "TADX Finance © 2026. تم التطوير بواسطة شركة TADX. جميع الحقوق محفوظة.",
    ...
    ledger: {
      ...
      subtitle: "الرصيد = المستحقات المعلقة + حصص الأرباح المحققة + رصيد مصاريف الشركة",
      noPartners: "لا يوجد شركاء بعد.",
      pendingShort: "مستحقات معلقة",
      profitShare: "حصة الربح",
      companyNet: "رصيد مصاريف الشركة",
      drawings: "المسحوبات",
